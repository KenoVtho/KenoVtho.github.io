function CInterface(){
    ...
    this._init = function(){                
        ...
        _pStartPosMoney = {x: 560, y: (oSprite.height/2) + 30};
        _oMoneyDisplay = new CTextButton(560, 65,oSprite,"0" ,PRIMARY_FONT,"#ffffff",40);
        _oMoneyDisplay.block(true);xxx*/
        ...
        _oButPlay1 = new CTextToggle(940,CANVAS_HEIGHT - 130,oSprite, TEXT_PLAY1,PRIMARY_FONT,"#ffffff",30, false, s_oStage);
        _oButPlay1.disable();
    ...
    this.refreshButtonPos = function(iNewX,iNewY){
        ...
        //_oMoneyDisplay.setPosition(_pStartPosMoney.x - iNewX,iNewY + _pStartPosMoney.y);xxx
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
    ...
    this.refreshMoney = function(szValue){
        //_oMoneyDisplay.setText(TEXT_CURRENCY + szValue)xxx
    };
